...
export const EARNING_COLUMNS = ({
  ...
  return [
    ...
    },
    {
      ...
      body: (earning: IEarning) =>
        isSuperAdmin ? (
          <div>Rs. {earning?.platformEarnings?.totalEarnings?.toFixed(2)}</div>
        ) : (
          <span>-</span>
        ),
    },
    ...
    },
    {
      ...
      body: (earning: IEarning) => (
        <div>Rs. {earning?.storeEarnings?.totalEarnings?.toFixed(2)}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      hidden: !isSuperAdmin,
      body: (earning: IEarning) => (
        <div>Rs. {earning?.riderEarnings?.totalEarnings?.toFixed(2)}</div>
      ),
    },
  ];
};
