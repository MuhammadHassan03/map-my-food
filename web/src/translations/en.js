const en = {
  translation: {
    ...
    saveButton: "Save",
    footerText:
      "Map My food is an open-source delivery management platform for the future. We prioritize innovation, flexibility, and affordability, and offer a scalable, customizable solution that streamlines your delivery processes.",
    footerLinkHome: "Home",
    footerLinkPP: "Privacy Policy",
    footerLinkTC: "Terms & Conditions",
    footerEndText: "Map My Food – © 2025 All Rights Reserved",
    followUs: "Follow Us",
    ...
    createAccount: "Create your Map My Food Account",
    ...
    Enatega: "Map My Food",
    connectText:
      "Connecting Riders, Restaurants, and Customers for Seamless Food Delivery in Trains",
    connectSubText:
    ...
    orderSubText1:
      "Experience the convenience of having all your favorite restaurant meals and cuisines in one place, delivered straight to your door—fast and fresh. Download the Map My Food App today, and turn every craving into a delicious reality.",
    orderSubText2:
      "Explore a wide range of options, from local favorites and comfort food to gourmet dishes, healthy eats, and more.",
    orderSubText3:
      "Download the Map My Food App today, and turn every craving into a delicious reality.",
    ...
    vendorDescription:
      "Expand your reach, attract more customers, and build stronger connections in every neighborhood. Join Map My Food as a vendor today!",
    ...
    welcomeText: "Welcome to Map My Food",
    emailConfirmationDescription:
      "We are thrilled to have you join us as we aim to make delivery better for everyone. As a delivery/pickup partner, you get to work according to your schedule anywhere, anytime. Need Help? send us an email at support@mapmyfood.com",
    getStarted: "Get Started",
    thankyouPageHeading: "Your email has been sent successfully!",
    thankyouPageDescription:
      "A member of our team will reach out to you shortly to help you get set-up and answer any questions you might have. Need Help? send us an email at support@mapmyfood.com",
